...
const Map = ({response}) => {
    const customIcon = new L.Icon ({ // Creates an instance of leaflet
    ...
    // Detects for a mobile phone
    if(L.Browser.mobile || /(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|ipad|iris|kindle|Android|Silk|lge |maemo|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(navigator.userAgent) 
        ...
        setShowZoom(false); // Removes zoom control on mobile phone
    }
        ...
        <>
            {
                ...
                <MapContainer center={[response.latitude, response.longitude]} zoom={13} 
                    scrollWheelZoom={false} className='h-[100vh] z-0' zoomControl={showZoom}>
